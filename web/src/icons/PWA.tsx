...
const PWA: React.FC<{ width?: number; height?: number; fillOuter?: string; fillInner?: string }> = ({
  width,
  height,
  fillOuter,
  fillInner,
  ...
  return (
    <svg
      ...
      baseProfile="full"
      enableBackground="new 0 0 1952 734.93"
      version="1.1"
